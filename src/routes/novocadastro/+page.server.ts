  ...
  return new Promise((res, rej) => {
    db.run(
      ...
      [
        ...
        dados.Apelidos?.trim() ?? null,
        dados.Curso?.trim() ?? null,
        dados.AnoInicio ?? null,
        dados.AnoTermino ?? null,
        dados.Email?.trim() ?? null,
        dados.ICQ ?? null,
        dados.HomePage?.trim() ?? null,
        dados.Endereco?.trim() ?? null,
        dados.Cidade?.trim() ?? null,
        dados.Estado?.trim() ?? null,
        dados.CEP?.trim() ?? null,
        dados.Pais?.trim() ?? null,
        dados.Telefone?.trim() ?? null,
        dados.DadoPubl?.trim() ?? null,
        dados.ComoEncontrou?.trim() ?? null,
        dados.ComoEncontrouExtra?.trim() ?? null,
